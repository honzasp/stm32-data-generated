...
# [inline (always)]
pub const fn ccr (self , n : usize) -> crate :: common :: Reg < regs :: Ccr1ch , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x34usize + n * 4usize) as _) } } # [doc = "Option register 1 Note: Check Reference Manual to parse this register content"]
# [inline (always)]
...
pub const fn or (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x50usize) as _) } } # [doc = "input selection register"]
# [inline (always)]
pub const fn tisel (self) -> crate :: common :: Reg < regs :: Tisel1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x68usize) as _) } } } # [doc = "General purpose 32-bit timers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn dcr (self) -> crate :: common :: Reg < regs :: DcrCcdma , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x48usize) as _) } } # [doc = "DMA address for full transfer"]
# [inline (always)]
...
# [inline (always)]
pub const fn af1 (self) -> crate :: common :: Reg < regs :: Af14ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x60usize) as _) } } # [doc = "input selection register"]
# [inline (always)]
pub const fn tisel (self) -> crate :: common :: Reg < regs :: Tisel1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x68usize) as _) } } } # [doc = "General purpose 16-bit timers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn bdtr (self) -> crate :: common :: Reg < regs :: BdtrAdv1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x44usize) as _) } } # [doc = "DMA control register"]
# [inline (always)]
pub const fn dcr (self) -> crate :: common :: Reg < regs :: DcrCcdma , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x48usize) as _) } } # [doc = "DMA address for full transfer"]
# [inline (always)]
pub const fn dmar (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x4cusize) as _) } } # [doc = "Option register 1 Note: Check Reference Manual to parse this register content"]
...
pub const fn or (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x50usize) as _) } } # [doc = "alternate function register 1"]
# [inline (always)]
pub const fn af1 (self) -> crate :: common :: Reg < regs :: Af1Adv1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x60usize) as _) } } # [doc = "input selection register"]
# [inline (always)]
pub const fn tisel (self) -> crate :: common :: Reg < regs :: Tisel1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x68usize) as _) } } } # [doc = "2-channel with one complementary output timers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub const fn af1 (self) -> crate :: common :: Reg < regs :: Af1Adv1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x60usize) as _) } } # [doc = "input selection register"]
# [inline (always)]
pub const fn tisel (self) -> crate :: common :: Reg < regs :: Tisel1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x68usize) as _) } } } # [doc = "Advanced Control timers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub const fn dmar (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x4cusize) as _) } } # [doc = "Option register 1 Note: Check Reference Manual to parse this register content"]
# [inline (always)]
pub const fn or (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x50usize) as _) } } # [doc = "capture/compare mode register 3 (output mode)"]
# [inline (always)]
pub const fn ccmr3_output (self) -> crate :: common :: Reg < regs :: Ccmr3OutputAdv4ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x54usize) as _) } } # [doc = "capture/compare register 5"]
# [inline (always)]
pub const fn ccr5 (self) -> crate :: common :: Reg < regs :: Ccr5Adv4ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x58usize) as _) } } # [doc = "capture/compare register 6"]
# [inline (always)]
...
# [inline (always)]
pub const fn af2 (self) -> crate :: common :: Reg < regs :: Af2Adv4ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x64usize) as _) } } # [doc = "input selection register"]
# [inline (always)]
pub const fn tisel (self) -> crate :: common :: Reg < regs :: Tisel1ch , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x68usize) as _) } } } # [doc = "Basic timers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub const fn psc (self) -> crate :: common :: Reg < u16 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x28usize) as _) } } # [doc = "auto-reload register"]
# [inline (always)]
pub const fn arr (self) -> crate :: common :: Reg < regs :: ArrCore , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x2cusize) as _) } } } # [doc = "Virtual timer for common parts of all timers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_bkcmpp (& mut self , n : usize , val : super :: vals :: Bkinp) { assert ! (n < 2usize) ; let offs = 10usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val . to_bits () as u32) & 0x01) << offs) ; } } impl Default for Af1Adv1ch { # [inline (always)]
...
# [inline (always)]
pub fn set_bk2ine (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "TIM_BRK2_CMPx (x=1-2) enable"]
# [inline (always)]
pub const fn bk2cmpe (& self , n : usize) -> bool { assert ! (n < 2usize) ; let offs = 1usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "TIM_BRK2_CMPx (x=1-2) enable"]
# [inline (always)]
pub fn set_bk2cmpe (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 1usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "BRK2 DFSDM1_BREAK1 enable"]
# [inline (always)]
...
# [inline (always)]
pub fn set_bk2cmpp (& mut self , n : usize , val : super :: vals :: Bkinp) { assert ! (n < 2usize) ; let offs = 10usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val . to_bits () as u32) & 0x01) << offs) ; } } impl Default for Af2Adv4ch { # [inline (always)]
fn default () -> Af2Adv4ch { Af2Adv4ch (0) } } # [doc = "alternate function register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Af2Ccdma (pub u32) ; impl Af2Ccdma { } impl Default for Af2Ccdma { # [inline (always)]
...
# [inline (always)]
pub fn set_bkf (& mut self , n : usize , val : super :: vals :: FilterValue) { assert ! (n < 2usize) ; let offs = 16usize + n * 4usize ; self . 0 = (self . 0 & ! (0x0f << offs)) | (((val . to_bits () as u32) & 0x0f) << offs) ; } } impl Default for BdtrAdv1ch { # [inline (always)]
...
pub const fn ccp (& self , n : usize) -> bool { assert ! (n < 4usize) ; let offs = 1usize + n * 4usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Capture/Compare x (x=1-4) output Polarity"]
# [inline (always)]
pub fn set_ccp (& mut self , n : usize , val : bool) { assert ! (n < 4usize) ; let offs = 1usize + n * 4usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Capture/Compare x (x=1-3) complementary output enable"]
# [inline (always)]
...
# [inline (always)]
pub fn set_ocm (& mut self , n : usize , val : super :: vals :: Ocm) { assert ! (n < 2usize) ; let offs = 4usize + n * 8usize ; self . 0 = (self . 0 & ! (0x07 << offs)) | (((val . to_bits () as u32) & 0x07) << offs) ; } } impl Default for CcmrOutput1ch { # [inline (always)]
...
fn default () -> Ccr5Adv4ch { Ccr5Adv4ch (0) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub const fn uifremap (& self) -> bool { let val = (self . 0 >> 11usize) & 0x01 ; val != 0 } # [doc = "UIF status bit remapping enable"]
# [inline (always)]
pub fn set_uifremap (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } } impl Default for Cr12ch { # [inline (always)]
...
pub const fn uifremap (& self) -> bool { let val = (self . 0 >> 11usize) & 0x01 ; val != 0 } # [doc = "UIF status bit remapping enable"]
# [inline (always)]
pub fn set_uifremap (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } } impl Default for Cr14ch { # [inline (always)]
...
pub const fn mms (& self) -> super :: vals :: Mms { let val = (self . 0 >> 4usize) & 0x07 ; super :: vals :: Mms :: from_bits (val as u8) } # [doc = "Master mode selection"]
# [inline (always)]
pub fn set_mms (& mut self , val : super :: vals :: Mms) { self . 0 = (self . 0 & ! (0x07 << 4usize)) | (((val . to_bits () as u32) & 0x07) << 4usize) ; } } impl Default for Cr2Mms { # [inline (always)]
...
# [inline (always)]
pub fn set_dbl (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x1f << 8usize)) | (((val as u32) & 0x1f) << 8usize) ; } } impl Default for DcrCcdma { # [inline (always)]
...
# [inline (always)]
pub fn set_tde (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } } impl Default for Dier4ch { # [inline (always)]
...
pub const fn tde (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "Trigger DMA request enable"]
# [inline (always)]
pub fn set_tde (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } } impl Default for DierAdv4ch { # [inline (always)]
...
fn default () -> DierUpdma { DierUpdma (0) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_etp (& mut self , val : super :: vals :: Etp) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val . to_bits () as u32) & 0x01) << 15usize) ; } } impl Default for Smcr4ch { # [inline (always)]
...
pub const fn etp (& self) -> super :: vals :: Etp { let val = (self . 0 >> 15usize) & 0x01 ; super :: vals :: Etp :: from_bits (val as u8) } # [doc = "External trigger polarity"]
# [inline (always)]
pub fn set_etp (& mut self , val : super :: vals :: Etp) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val . to_bits () as u32) & 0x01) << 15usize) ; } } impl Default for SmcrAdv4ch { # [inline (always)]
...
pub const fn msm (& self) -> super :: vals :: Msm { let val = (self . 0 >> 7usize) & 0x01 ; super :: vals :: Msm :: from_bits (val as u8) } # [doc = "Master/Slave mode"]
# [inline (always)]
pub fn set_msm (& mut self , val : super :: vals :: Msm) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val . to_bits () as u32) & 0x01) << 7usize) ; } } impl Default for SmcrTrigdma { # [inline (always)]
...
pub const fn ccof (& self , n : usize) -> bool { assert ! (n < 4usize) ; let offs = 9usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Capture/Compare x (x=1-4) overcapture flag"]
# [inline (always)]
pub fn set_ccof (& mut self , n : usize , val : bool) { assert ! (n < 4usize) ; let offs = 9usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Sr4ch { # [inline (always)]
...
# [inline (always)]
pub fn set_ccif6 (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize) ; } } impl Default for SrAdv4ch { # [inline (always)]
