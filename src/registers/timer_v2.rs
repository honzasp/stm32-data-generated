    ...
    blocks: &[
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "ccr_dither",
                    description: Some(
                        "capture/compare register x (x=1-4) (dither mode enabled)",
                    ),
                    array: Some(
                        Array::Regular(
                            RegularArray {
        ...
        Block {
            ...
            extends: None,
            description: Some(
                "Virtual timer for common parts of all timers",
            ),
            items: &[
                BlockItem {
                    name: "cr1",
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "bkcmpp",
                    description: Some(
                        "TIM_BRK_CMPx (x=1-3) input polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
